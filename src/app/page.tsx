        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-muted/30">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-3 pt-12">
              <div className="grid gap-4 p-6 rounded-lg border bg-card text-card-foreground shadow-sm animate-fade-in-scroll duration-500 delay-200">
              ...
              <div className="grid gap-4 p-6 rounded-lg border bg-card text-card-foreground shadow-sm animate-fade-in-scroll duration-500 delay-300">
                <div className="flex items-center gap-4">
                  <div className="bg-primary/10 text-primary p-3 rounded-full">
              ...
              <div className="grid gap-4 p-6 rounded-lg border bg-card text-card-foreground shadow-sm animate-fade-in-scroll duration-500 delay-400">
                <div className="flex items-center gap-4">
                  <div className="bg-primary/10 text-primary p-3 rounded-full">
